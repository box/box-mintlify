...
to a private one, you will get the [`cannot_make_collaborated_subfolder_private`](/guides/api-calls/permissions-and-errors/common-errors#400-bad-request) error.
