...
<Frame center>
  ![CLI Login](/images/guides/cli/cli-login.png)
</Frame>

Click the **Grant access to Box** button that appears in the browser window.

<Frame center>
  ![Grant CLI Access](/images/guides/cli/cli-grant-access.png)
</Frame>

If successful, you will see the following success message.

<Frame center>
  ![CLI Env Setup](/images/guides/cli/cli-env-setup.png)
</Frame>
...
<Frame center>
  ![CLI Users Call](/images/guides/cli/cli-first-call.png)
</Frame>
