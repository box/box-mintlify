...
installed and configured. If you haven't done so yet, see <Link href="/guides/cli/quick-start/create-oauth-app">step 1</Link> of
this quick start guide.
Alternatively, go to your [developer console][console], and follow the guide
<Link href="/guides/authentication/oauth2/oauth2-setup">Setup with OAuth 2.0</Link>.
...
<Frame border center>
  ![Finished Folder Structure](/images/guides/cli/final-folder-structure.png)
</Frame>
...
Make sure to explore our other <Link href="/guides/cli/scripts">sample scripts</Link> for more use cases.
