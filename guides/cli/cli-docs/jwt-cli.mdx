...
/>
Previously, our <Link href="/guides/cli/quick-start">Box CLI Quick Start Guide</Link>, followed the JWT or server
...
At a minimum, you will need the following <Link href="/guides/api-calls/permissions-and-errors/scopes">scopes</Link>:
...
<Frame center>
    ![App Authorized](/images/guides/cli/app-authorized.png)
</Frame>
...
<Frame center>
  ...
  ![CLI Configuration Diagram](/images/guides/cli/cli-config-diagram.png)
  </div>
</Frame>
