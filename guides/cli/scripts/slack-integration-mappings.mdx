...
Configure and install the Box CLI using the OAuth <Link href="/guides/cli/quick-start">CLI Setup Quick Start</Link>. Make sure the user you use is an admin or co-admin.
