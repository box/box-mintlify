...
<Link href="/reference/put-files-id">update file</Link> or
<Link href="/reference/put-folders-id">update folder</Link> or
<Link href="/reference/put-web-links-id">update weblink</Link> endpoint and setting the
