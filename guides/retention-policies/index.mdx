...
Before using any of the Retention Policy APIs, an application must have the following [scopes][scopes] enabled: 
* [Manage Retention Policies][manage-retention], available in the Developer Console under **Configuration** > **Application Scopes**
* [Global Content Manager (GCM)][gcm], enabled by contacting customer support

[scopes]: /guides/api-calls/permissions-and-errors/scopes
[policy]: /reference/resources/retention-policy
[assignment]: /reference/resources/retention-policy-assignment
[retention]: /reference/resources/file-version-retention
...
[manage-retention]: https://developer.box.com/guides/api-calls/permissions-and-errors/scopes#manage-retention-policies
[gcm]: https://developer.box.com/guides/api-calls/permissions-and-errors/scopes#global-content-manager-gcm
