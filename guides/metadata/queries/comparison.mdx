...
At the surface the <Link href="/reference/post-metadata-queries-execute-read">Metadata Query API</Link> seems very similar to the
<Link href="/reference/get-search">Search for content API</Link>, but there are several important
...
|                   | <Link href="/reference/post-metadata-queries-execute-read">Metadata Query API</Link>                                                                                                                                                                                                                                                                                       | <Link href="/reference/get-search">Search API</Link>                                                                                                                                                                                                                                                                                                                                    |
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
In this case the <Link href="/reference/get-search">Search API</Link> is recommended. This API matches terms
...
In this case the <Link href="/reference/post-metadata-queries-execute-read">Metadata Query API</Link> is recommended. With a metadata
