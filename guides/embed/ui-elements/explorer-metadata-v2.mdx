...
The metadata view of <Link href="/guides/embed/ui-elements/explorer/">Content Explorer</Link> allows you to display files and folders based on their metadata.
...
<Frame>
![Metadata view](/images/guides/embed/ui-elements/explorer-metadata-v2.png)
</Frame>
...
- A valid <Link href="/guides/authentication/tokens/developer-tokens/">developer token</Link>
- A configured metadata template applied to target folder or files. See <Link href="/guides/metadata/templates/create">creating templates with API</Link> or [with the Admin Console][creating-templates-ui].
...
| `metadataQuery` | Metadata query request body matching the <Link href="/reference/post-metadata-queries-execute-read/">Metadata Query API</Link> schema. |
...
Depending on your needs and setup, Box UI Elements can be used with Vanilla JavaScript or React. You can learn more about installation from the <Link href="/guides/embed/ui-elements/installation">Installation</Link> guide. 
...
<Frame>
![Row selection](/images/guides/embed/ui-elements/explorer-select.png)
</Frame>
...
<Frame>
![Editing metadata](/images/guides/embed/ui-elements/explorer-edit.png)
</Frame>
...
Filter items by the file type, filter folders, or filter by metadata field values specified in the Box <Link href="/guides/metadata/templates/">metadata templates</Link>.
...
<Frame>
![Grid view](/images/guides/embed/ui-elements/explorer-grid.png)
</Frame>
