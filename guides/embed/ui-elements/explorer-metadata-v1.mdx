...
<Frame>
![Metadata view](/images/guides/embed/ui-elements/explorer-view.png)
</Frame>
...
1. <Link href="/guides/applications/app-types">Create a Box app</Link>.
2. Add the local development address in the CORS Domains: ![CORS Domains](/images/guides/embed/ui-elements/box-app-cors.png)
