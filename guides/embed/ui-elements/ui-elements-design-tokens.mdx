...
/>
This table shows all the design tokens you can use for <Link href="/guides/embed/ui-elements/theming-styling">theming and styling</Link> purposes. Provided default values and descriptions give clarity and guidance for implementation.
...
<RelatedLinks
  ...
  items={[
    ...
    { label: "Theming & styling for Box UI Elements", href: "/guides/embed/ui-elements/theming-styling", badge: "GUIDE" }
  ]}
/>
