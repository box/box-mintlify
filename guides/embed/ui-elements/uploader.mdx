...
and drop to upload. Large files will be uploaded with the <Link href="/reference/post-files-upload-sessions">Chunked
Upload</Link> API.
...
the Content Uploader functionality, you can use <Link href="/guides/authentication/tokens/downscope">Downscoping</Link> to
