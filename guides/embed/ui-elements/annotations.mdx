...
<Link href="/guides/embed/ui-elements/browser">Learn more about browser support</Link> for Box UI
element.
...
<Link href="/guides/authentication/tokens/downscope">Downscoping</Link> to appropriately
...
learn more, see <Link href="/guides/embed/ui-elements/scopes">Dedicated scopes for the Box UI
Elements</Link>.
...
options override global `showAnnotations` value, for that viewer. See <Link href="/guides/embed/ui-elements/preview">Box
Content Preview</Link> for more details on how to
