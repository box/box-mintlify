...
as well as the <Link href="/reference/resources/file--full/#param-expiring_embed_link">expiring embed link object</Link>.
...
reason for this is that UI Elements only expect a <Link href="/guides/authentication/tokens/developer-tokens">token</Link> for authentication, and Box provides two different ways to generate tokens - OAuth and JWT.
...
You can enable V4 <Link href="/guides/embed/ui-elements/annotations.md">annotations</Link> in content preview. New
...
<Frame>
![Box UI Element with Box AI options enabled](/images/guides/embed/ui-elements/box-ai-ui-element.jpg)
</Frame>
...
2. Download the [npm package that contains Box AI for UI Elements][aipackage] or directly from <Link href="/guides/embed/ui-elements/installation">Box CDN</Link>.
...
the Content Preview functionality, you can use <Link href="/guides/authentication/tokens/downscope">Downscoping</Link> to
