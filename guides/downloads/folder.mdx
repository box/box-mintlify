...
<Note>
To download a ZIP archive, follow <Link href="/guides/downloads/zip-archive">this</Link> guide.
</Note>
...
<Warning>
  ...
  Lear more about <Link href="/platform/user-types">User Types</Link> in our guides on
  authentication.
</Warning>
