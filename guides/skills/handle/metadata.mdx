...
|                                         |                                                                                                                                 |                                        |
|-----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [Keyword](/reference/resources/keyword-skill-card)       | Displays a list of keywords next to the file.                                                                                   | ![Image](./images/skills-card-keyword.png)    |
| [Timeline](/reference/resources/timeline-skill-card)     | Displays a set of text/images, and when clicked shows when those images appear in a timeline.                                   | ![Image](./images/skills-card-timeline.png)   |
| [Transcript](/reference/resources/transcript-skill-card) | Displays a transcript with the corresponding timestamps.                                                                        | ![Image](./images/skills-card-transcript.png) |
