...
|                                         |                                                                                                                                 |                                        |
|-----------------------------------------|---------------------------------------------------------------------------------------------------------------------------------|----------------------------------------|
| [Keyword](/reference/resources/keyword-skill-card)       | Displays a list of keywords next to the file.                                                                                   | ![Image](/images/guides/skills/handle/skills-card-keyword.png)    |
| [Timeline](/reference/resources/timeline-skill-card)     | Displays a set of text/images, and when clicked shows when those images appear in a timeline.                                   | ![Image](/images/guides/skills/handle/skills-card-timeline.png)   |
| [Transcript](/reference/resources/transcript-skill-card) | Displays a transcript with the corresponding timestamps.                                                                        | ![Image](/images/guides/skills/handle/skills-card-transcript.png) |
| [Status](/reference/resources/status-skill-card)         | Displays a status to the user, which can be used to inform the user of the status of the Skill while it is processing the file. |                                        |

## Write metadata cards to file

To write one or more cards to a file, you can use the [`POST
/files/:id/metadata/global/boxSkillsCards`](/reference/post-files-id-metadata-global-boxSkillsCards)
