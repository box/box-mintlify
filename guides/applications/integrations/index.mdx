...
quickly find featured, most popular, or recently added apps.
  ...
  <Frame>
  ![Integrations](/images/guides/applications/integrations/box-integrations.png)
  </Frame>
...
2. Select the **Publishing** tab from the top menu.
    ...
    <Frame>
    ![Publishing tab for an application](/images/guides/applications/integrations/publishing-app.png)
    </Frame>
