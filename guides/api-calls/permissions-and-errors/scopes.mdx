...
application's scopes determine which <Link href="/reference">endpoints</Link> an application can
successfully call and are reflected in the access provided by
<Link href="/guides/authentication/tokens">Access Tokens</Link> of the application.
...
together, see our <Link href="/guides/security">security guide</Link>.
...
In the case of a <Link href="/guides/authentication/jwt">JWT</Link> application accessing a <Link href="/platform/user-types/#managed-users">Managed User's</Link>
items, the Service Account's Token will need to either use the `as-user`
<Link href="/guides/authentication/jwt/as-user">header</Link> or create a <Link href="/guides/authentication/jwt/user-access-tokens">User Access Token</Link> to directly authenticate as
...
Gives an application permission to manage <Link href="/platform/user-types/#managed-users">Managed Users</Link>. It
...
**App Access + Enterprise Access** <Link href="/guides/authentication/jwt/jwt-setup/#application-access">application access</Link>.
</Note>
...
Gives an application permission to manage <Link href="/platform/user-types/#app-user">App Users</Link>, which means this
...
Please review webhook <Link href="/guides/webhooks/v2/limitations-v2">limitations</Link>. Most
...
Allows some types of <Link href="/guides/api-calls/suppress-notifications">email notifications</Link> to be suppressed when API
calls are made.
...
Allows Admins, [Co-Admins][ca], and <Link href="/platform/user-types/#service-account">Service Accounts</Link> to retrieve any content
...
In some cases an Access Token needs to be <Link href="/guides/authentication/tokens/downscope">downscoped</Link> to a more strict
...
<Link href="/reference/post-oauth2-token">`POST /oauth2/token`</Link> endpoint to downscope an
