...
<Frame border>
  ![Unable to retreive error](/images/guides/authorization/unable_to_retreive.png)
</Frame>
...
<Frame border>
  ![Something went wrong error](/images/guides/authorization/something_went_wrong.png)
</Frame>
...
<Frame border>
  ![Admin error](/images/guides/authorization/admin_error.png)
</Frame>
