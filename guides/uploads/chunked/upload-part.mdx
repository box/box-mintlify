...
First, <Link href="/guides/uploads/chunked/create-session">create an upload session</Link>. The resulting
...
<Warning>
  ...
  uploads as they are needed to <Link href="/guides/uploads/chunked/commit-session">commit the session</Link>.
</Warning>
