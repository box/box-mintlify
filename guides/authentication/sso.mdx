...
When users authenticate with a <Link href="/guides/applications/app-types/platform-apps">Platform App</Link> configured to use
...
For <Link href="/guides/applications/app-types/platform-apps">Platform Apps</Link> that use <Link href="/guides/authentication/jwt/jwt-setup">JWT</Link> or
<Link href="/guides/authentication/client-credentials">Client Credentials Grant</Link> and
<Link href="/guides/applications/web-app-integrations">Limited Access Apps</Link> that use <Link href="/guides/authentication/app-token">App Token</Link> authentication,
...
<Link href="/guides/applications/app-types/custom-skills">Custom Skills</Link> are authenticated in a unique way where the
