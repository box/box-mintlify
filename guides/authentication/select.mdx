...
<Card href="guides/applications/platform-apps/create" arrow title="Learn how to create a Platform App"/>
...
| ---------------------------- | ------------------- | ---- | ------------------- | ---------- |
| <Link href="/guides/applications/app-types/platform-apps">Platform App</Link>     | Yes                 | Yes  | Yes                 | No         | 
| <Link href="/guides/applications/app-types/limited-access-apps">Limited Access App</Link> | No                  | No  | No                  | Yes        |
| <Link href="/guides/applications/app-types/custom-skills">Custom Skill</Link> | No                  | No   | No                  | No         |
