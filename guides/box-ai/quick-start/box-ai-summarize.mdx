...
document content into instant insights without the need to build and maintain complex Retrival Augmented Genration (RAG) pipelines.
...
<Steps>
  ...
  <Step title="Upload a test file">
    ...
    [federal code](/static/quickstarts/summarize/files/CFR-2024-title28-vol1-sec2-20.pdf).
...
The last part of the path is your file ID. For example, the URL might look like this:
  ...
  <Step title="Configure the environment">
    Now set up your development environment to run this quickstart. We use Python and the 
    Box Python SDK version 10 to run the code. Make sure you have Python 3.11 or higher installed on your machine.
...
3. Print out the summary to the console to verify that the operation was successful by running the following command in your terminal:
    ...
    If the summarization was successful, the console displays your user ID followed by the summary from the federal code document.
