...
<Link href="/ai-dev-zone">Box AI</Link> exposes intelligent extraction capabilities that enable developers to automatically extract
...
<Steps>
  ...
  <Step title="Upload a test file">
    ...
    <Link href="/static/quickstarts/extract/files/freeform-extract-file.pdf">sample W-2</Link>.
...
2. Add the function call to extract the metadata in the `main` function. Ensure that the new `main` function contains the following logic: 
    ...
    <Link href="/reference/resources/ai-extract-response">`AiExtractResponse`</Link> object. In this quick start,
...
## Resources
- <Link href="https://github.com/box-community/box-quickstarts/tree/main/box-ai-freeform-extract-quickstart">Final code</Link>
- <Link href="/reference/post-ai-extract">Extract Freeform Metadata API Reference</Link>
