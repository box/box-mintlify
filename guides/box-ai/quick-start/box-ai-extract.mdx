---
title: Extract structured data with Box AI in Python
...
The last part of the path is your file ID. For example, the URL might look like this:
  ...
  <Step title="Configure the environment">
    Now set up our development environment to run the extraction. For this quick start, use Python and the 
    ...
    6. To get your developer token, go to the Box Developer Console, open your app, and navigate to 
...
## Resources
- [Final code](https://github.com/box-community/box-ai-extract-quick)
