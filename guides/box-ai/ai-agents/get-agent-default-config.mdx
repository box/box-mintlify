...
Once you get the configuration details you can override them using the <Link href="/guides/box-ai/ai-agents/ai-agent-overrides">`ai_agent`</Link> parameter.
...
to authorize your app. See <Link href="/guides/box-ai/ai-tutorials/prerequisites">getting started with Box AI</Link>
for details.
...
|`model`|The model you want to get the configuration for. To make sure your chosen model is supported, see the <Link href="/guides/box-ai/ai-models">list of models</Link>.| `azure__openai__gpt_4o_mini`|
