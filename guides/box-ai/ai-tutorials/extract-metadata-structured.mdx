...
To learn more about creating templates, see [Creating metadata templates in the Admin Console][templates-console] or use the [metadata template API][templates-api]. You can also [autofill metadata in templates][autofill-metadata] using our Standard or Enhanced Extraction Agent.
...
<Frame>
![sample invoice](/images/guides/box-ai/sample-invoice.png)
</Frame>
