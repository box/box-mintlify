...
<RelatedLinks
  ...
  items={[
    ...
    { label: "Use freeform metadata extraction with Box Python SDK", href: "/guides/box-ai/quick-start/extract-freeform", badge: "QUICKSTART" },
    { label: "Use structured metadata extraction with Box Python SDK", href: "/guides/box-ai/quick-start/extract-structured", badge: "QUICKSTART" },
    { label: "Use enhanced agent with structured metadata extraction with Box Python SDK", href: "/guides/box-ai/quick-start/extract-enhanced", badge: "QUICKSTART" },
