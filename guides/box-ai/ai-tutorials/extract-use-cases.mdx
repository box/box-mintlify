...
<AccordionGroup>
    <Accordion title="Sales & finance operations">
        **Recommended Endpoint:** structured metadata extraction (`POST /2.0/ai/extract_structured`):
        ...
        - Enable automated data entry for finance teams. Structured metadata extraction ensures consistent JSON response every time thanks to a preconfigured metadata template.
        - **Invoices & purchase orders:** Extract line items, totals, and dates.
