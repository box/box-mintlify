...
<Choice option='postman.app_type' value='create_new,use_existing,clicked' color='none'>
  ...
  previous step to log in and create an **Access Token** for your user.

  Before logging in, you should [create a new request][new_request] in Postman, select the GET method, and enter a Box API endpoint.
...
*/}
  ...
  3. Complete the fields, including the **Client ID** and **Client Secret**.
  4. Click **Get New Access Token**.

  A browser window appears where you can log in to your Box account. 
  
  Once the process is complete and approved, Postman will receive your [access token][access_token].
{/*
