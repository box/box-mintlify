...
<Choice option='postman.app_type' value='create_new,clicked' color='blue'>
  ...
  5. Scroll down to the **Application Scopes** section to select your desired [scopes][scopes]. **Your application must have at least one or more** **of the following scopes:** manage users, read all files and folders stored in Box, read and write all files and folders in Box.
