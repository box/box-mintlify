...
To listen to another event, <Link href="/guides/webhooks/v2/update-v2">update</Link> the existing webhook or create a
new application.
...
<Link href="/guides/webhooks/v2/update-v2">update existing webhooks</Link> to apply to higher levels in the folder tree.
...
`0`. Instead, you will need to use a <Link href="/guides/webhooks/v1">v1 webhook</Link>.
