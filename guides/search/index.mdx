...
<Note>
  Explore the <Link href="/reference/get-search">reference documentation</Link> to learn more
...
<Link href="/guides/search/query-operators">search operators</Link>, including
...
to the <Link href="/guides/metadata/queries">Metadata Query API</Link>, but there are several important differences
