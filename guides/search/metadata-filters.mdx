...
The <Link href="/reference/get-search">`GET /search`</Link> API allows for filtering search results by their
...
<Info>
  ...
  <Link href="/guides/metadata/templates/list">list all metadata templates</Link> for an enterprise, or
  <Link href="/guides/metadata/instances/list">list all metadata instances on an item</Link>.
