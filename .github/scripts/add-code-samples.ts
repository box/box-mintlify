 ...
 */
export async function main(directory: string, pattern: string, outputPath?: string): Promise<number> {
  ...
  try {
    ...
    writeOpenAPISchemas(schemas, outputPath);
    console.log();
...
if (require.main === module) {
  ...
  program
    .name('add-code-samples')
    .description('Extract code samples from SDK repositories and add them to OpenAPI specifications')
