<Update label="2022-03-03" description="Developer Documentation Updates" tags={["New features", "Impactful changes", "API"]}>
...
[folder-lock]: /reference/resources/folder-lock
