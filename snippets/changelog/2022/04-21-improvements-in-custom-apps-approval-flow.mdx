<Update label="2022-04-21" description="Improvements In Platform Apps Approval Flow" tags={["New features", "Impactful changes", "API"]}>
...
[2]: /guides/authorization/platform-app-approval
