<Update label="2022-05-12" description="New Field Added to Sign Requests" tags={["New features", "Impactful changes", "API"]}>
...
[2]: /reference/resources/sign-request/#param-signers-inputs-content_type
</Update>
