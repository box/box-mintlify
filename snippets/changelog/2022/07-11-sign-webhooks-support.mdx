<Update label="2021-06-24" description="New Box Sign webhook triggers" tags={["New features", "Impactful changes", "API"]}>
...
[1]: /guides/webhooks/triggers
[2]: /guides/webhooks/v2/create-v2
