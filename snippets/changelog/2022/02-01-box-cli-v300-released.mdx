<Update label="2022-02-01" description="Box CLI v3.0.0 released" tags={["New features", "Impactful changes", "CLI"]}>
...
[19]: /guides/cli/quick-start

[20]: /guides/cli/cli-docs/jwt-cli
</Update>
