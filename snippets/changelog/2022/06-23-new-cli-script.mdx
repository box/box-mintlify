<Update label="2021-06-24" description="Automate tasks with Box CLI and scripts library" tags={["New features", "Impactful changes", "CLI"]}>
...
[3]: /guides/cli
[4]: /guides/cli/quick-start/powershell-script-templates
