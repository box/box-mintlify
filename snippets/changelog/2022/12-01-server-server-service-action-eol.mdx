<Update label="2022-12-01" description="Server-side actions no longer supported in Web App Integrations" tags={["New features", "Impactful changes", "API"]}>
...
[3]: /guides/applications/web-app-integrations/
</Update>
