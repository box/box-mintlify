<Update label="2022-05-06" description="New Field Added to Sign Events Payload" tags={["New features", "Impactful changes", "API"]}>
...
[2]: /guides/events/event-triggers/sign-events
</Update>
