<Update label="2022-08-24" description="Updates to Box CLI" tags={["New features", "Impactful changes", "CLI"]}>
...
[1]: /guides/cli/scripts
[2]: /guides/cli/cli-docs
[3]: /guides/cli/scripts/provision-users-folders
[4]: /guides/cli/scripts/manage-groups-collaborations
[5]: /guides/cli/scripts/report-inactive-users
[6]: /guides/cli/scripts/user-zones-mass-update
[7]: /guides/cli/scripts/deprovision-users
[8]: /guides/cli/cli-docs/bulk-commands
