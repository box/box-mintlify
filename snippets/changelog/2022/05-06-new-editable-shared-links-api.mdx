<Update label="2021-05-06" description="New Editable Shared Links API" tags={["New features", "Impactful changes", "API"]}>
...
[2]: /reference/resources/folder--full#param-shared_link-permissions
[3]: /reference/resources/file--full#param-shared_link-permissions
[4]: /reference/resources/file--full/#param-shared_link_permission_options
[5]: /reference/resources/web-link/#param-shared_link-permissions
[6]: /reference/get-shared-items--web-links
[7]: /guides/shared-links/permissions
[8]: /guides/shared-links/create-or-update
</Update>
