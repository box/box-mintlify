<Update label="2022-02-10" description="Client Credentials support in the SDKs" tags={["New features", "Impactful changes", "API", "Windows"]}>
...
[4]: /guides/authentication/client-credentials/
