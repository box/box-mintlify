<Update label={<span>Box AI API - new AI models now available, Gemini 1.5 models deprecated</span>} description="2025-05-24" tags={["New features", "Impactful changes", "API", "AI"]}>
