<Update label={<span>Box AI API - Google Gemini 2.5 Pro now available, Gemini 2.5 Flash Preview and Pro Preview deprecated</span>} description="2025-07-27" tags={["新機能", "影響度の高い変更", "API", "AI"]}>
