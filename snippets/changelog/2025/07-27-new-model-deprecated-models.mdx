<Update label="2025-07-27" description="Box AI API - Google Gemini 2.5 Pro now available, Gemini 2.5 Flash Preview and Pro Preview deprecated" tags={["New features", "Impactful changes", "API", "AI"]}>
