<Update label="2024-01-19" description="New event parameter for Shield Suspicious Location alert" tags={["New features", "Impactful changes", "API"]}>
...
[1]: /guides/events/event-triggers/shield-alert-events/#suspicious-locations-alert
