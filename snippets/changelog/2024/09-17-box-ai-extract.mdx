<Update label={<span>Metadata extraction with Box AI Platform API now available in Beta</span>} description="2024-09-17" tags={["New features", "Impactful changes", "API"]}>
