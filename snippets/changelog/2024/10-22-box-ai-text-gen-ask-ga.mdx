<Update label="2024-10-22" description="Box AI API — Document Q&A and Box AI API — Text Generation generally available" tags={["New features", "Impactful changes", "API"]}>
...
[2]: /guides/box-ai/ai-tutorials/ask-questions/
[3]: /guides/box-ai/ai-tutorials/generate-text/
[4]: https://support.box.com/hc/en-us/articles/360044194033-Customizing-Metadata-Templates
[5]: /reference/ai-agent-ask/
[6]: /guides/embed/ui-elements/preview#box-ai-ui-element
[7]: /guides/embed/ui-elements/preview
