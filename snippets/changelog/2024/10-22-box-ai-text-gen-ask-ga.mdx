<Update label={<span>Box AI API — Document Q&A and Box AI API — Text Generation generally available</span>} description="2024-10-22" tags={["New features", "Impactful changes", "API"]}>
