<Update label="2024-05-03" description="Introducing Box AI API and Box AI Dev Zone" tags={["New features", "Impactful changes", "API"]}>
...
[3]: /guides/embed/ui-elements/preview#box-ai-ui-element
