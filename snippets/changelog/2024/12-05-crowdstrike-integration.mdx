<Update label="2024-12-05" description="CrowdStrike integration with Box" tags={["New features", "Impactful changes", "API"]}>
...
[1]: /guides/events/enterprise-events/for-enterprise#event-types
