<Update label="2023-04-17" description="Add more details to Custom Apps" tags={["New features", "Impactful changes", "API"]}>
...
[1]: /guides/applications/app-types/platform-apps
[2]: /guides/authentication/oauth2/oauth2-setup
[3]: /guides/authentication/jwt/jwt-setup
[4]: /guides/authentication/client-credentials/client-credentials-setup
