<Update label="2023-08-16" description="Introducing Embedded Box Sign Client" tags={["New features", "API"]}>
...
[1]: /guides/embed/box-embed
[2]: /guides/box-sign/create-sign-request#embedded-sign-client
[3]: /reference/resources/sign-request#param-signers-iframeable_embed_url
