<Update label="2023-07-26" description="Improvements in App Access Level for JWT authentication" tags={["New features", "API"]}>
...
[1]: /guides/authentication/jwt/jwt-setup
