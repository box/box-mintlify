<Update label="2025-09-05" description="コンテンツエクスプローラのメタデータビューv2" tags={["UI Elements"]}>
...
[1]: /ja/guides/embed/ui-elements/explorer-metadata-v2

[2]: https://community.box.com/

[3]: /ja/guides/embed/ui-elements/explorer-metadata-v2/#migrating-from-v1-to-v2
</Update>
