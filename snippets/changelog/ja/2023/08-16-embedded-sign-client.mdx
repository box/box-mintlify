<Update label="2023-08-16" description="Box Signクライアントの埋め込み機能の導入" tags={["新機能", "API"]}>
...
[1]: /ja/guides/embed/box-embed

[2]: /ja/guides/box-sign/create-sign-request#embedded-sign-client

[3]: /ja/reference/resources/sign-request#param-signers-iframeable_embed_url
