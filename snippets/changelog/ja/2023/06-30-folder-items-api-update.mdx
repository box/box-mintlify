<Update label="2023-06-30" description="共有フォルダのフォルダ項目の並べ替えに対する更新" tags={["新機能", "API"]}>
...
[1]: /ja/reference/get-folders-id-items

[2]: /ja/reference/get-folders-id-items#param-sort
