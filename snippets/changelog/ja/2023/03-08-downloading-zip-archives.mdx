<Update label="2023-03-08" description="Box APIを使用したZIPアーカイブのダウンロード" tags={["新機能", "API"]}>
...
[1]: /ja/guides/downloads/zip-archive

[2]: /ja/reference/post-zip-downloads

[3]: /ja/reference/get-zip-downloads-id-content
