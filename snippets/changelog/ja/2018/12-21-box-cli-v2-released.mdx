<Update label="2018-12-21" description="Box CLI V2のリリース" tags={["新機能", "影響度の高い変更", "CLI"]}>
...
[ガイド][guide]: [/ja/guides/cli/quick-start/install-and-configure][/ja/guides/cli/quick-start/install-and-configure]
</Update>
