<Update label="2022-05-18" description="OAuth 2.0のリダイレクトURLの厳密なチェックの有効化" tags={["新機能", "影響度の高い変更", "API"]}>
...
[oauth-setup]: /ja/guides/authentication/oauth2/oauth2-setup/

[oauth-sdk]: /ja/guides/authentication/oauth2/with-sdk/

[oauth-nosdk]: /ja/guides/authentication/oauth2/without-sdk/
