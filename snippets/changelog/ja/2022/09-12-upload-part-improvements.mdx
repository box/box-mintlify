<Update label="2022-09-12" description="分割アップロードに関するガイドの改善" tags={["新機能", "影響度の高い変更", "API"]}>
...
[2]: /ja/guides/uploads/chunked/upload-part

[3]: /ja/reference/put-files-upload-sessions-id
</Update>
