<Update label="2021-09-01" description="イベントAPIで分類の名前フィールドが追加" tags={["新機能", "API"]}>
...
[events]: /ja/reference/get-events/

[event-source]: /ja/reference/resources/event-source/

[event-triggers]: /ja/guides/events/event-triggers/event-source
</Update>
