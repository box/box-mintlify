<Update label="2021-07-16" description="手動開始ワークフローの新しいエンドポイント" tags={["新機能", "API"]}>
...
* 新しい[ワークフロー](/ja/reference/resources/workflow)リソース
* 新しい[GET](/ja/reference/get_workflows)ワークフローエンドポイント
* 新しい[POST](/ja/reference/post_workflows_id_start)手動開始ワークフローエンドポイント
</Update>
