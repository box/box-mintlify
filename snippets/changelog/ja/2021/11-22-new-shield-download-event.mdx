<Update label="2021-11-22" description="新しいShieldダウンロードイベント" tags={["新機能", "API"]}>
...
[new-event]: /ja/guides/events/event-triggers/shield-alert-events/#download-restriction

[event-list]: /ja/guides/events/enterprise-events/for-enterprise/#event-types
</Update>
