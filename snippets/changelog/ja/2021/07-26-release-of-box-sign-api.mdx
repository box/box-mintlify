<Update label="2021-07-26" description="Box Sign APIのリリース" tags={["新機能", "API", "Java"]}>
...
[c]: /ja/guides/box-sign/create-sign-request

[c_ref]: /ja/reference//post-sign-requests

[l]: /ja/guides/box-sign/list-sign-requests/#all

[l_ref]: /ja/reference/get-sign-requests

[g]: /ja/guides/box-sign/list-sign-requests/#by-id

[g_ref]: /ja/reference/get-sign-requests-id

[r]: /ja/guides/box-sign/resend-sign-request

[r_ref]: /ja/reference/post-sign-requests-id-resend

[ca]: /ja/guides/box-sign/cancel-sign-request

[ca_ref]: /ja/reference/post-sign-requests-id-cancel
