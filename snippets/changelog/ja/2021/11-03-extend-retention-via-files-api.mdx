<Update label="2021-11-03" description="ファイルAPIを使用したリテンションポリシーの拡張" tags={["新機能", "API"]}>
...
[extend-retention]: /ja/guides/retention-policies/#extend-retention-for-a-file

[file-put]: /ja/reference/put-files-id/#param-disposition_at

[file-full]: /ja/reference/resources/file--full/#param-disposition_at
</Update>
