<Update label="2021-11-17" description="stream_typeをライブで監視する新しいイベントストリーム" tags={["新機能", "影響度の高い変更", "API"]}>
...
[event-api]: /ja/reference/get-events

[event-guide]: /ja/guides/events

[migration]: /ja/guides/events/enterprise-events/migrate-to-stream
</Update>
