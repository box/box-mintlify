...
[copy]: /ja/reference/post-file-requests-id-copy

[get]: /ja/reference/get-file-requests-id

[del]: /ja/reference/delete-file-requests-id

[put]: /ja/reference/put-file-requests-id
