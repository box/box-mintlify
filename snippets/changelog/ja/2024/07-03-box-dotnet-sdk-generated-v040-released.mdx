<Update label={<span>Box Dotnet SDK Generated <code>v0.4.0</code>のリリース</span>} description="2024-07-03" tags={["新機能"]}>
  ### バグ修正
...
* ドキュメントの改善とマーカーページネーションを追加 (box/box-openapi[#431][16]) ([#153][17]) ([`780a58b`][18])
