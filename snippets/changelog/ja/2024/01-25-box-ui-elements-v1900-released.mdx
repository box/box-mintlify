<Update label={<span>Box UI Elements <code>v19.0.0</code>のリリース</span>} description="2024-01-25" tags={["新機能", "影響度の高い変更", "UI Elements"]}>
  # [19.0.0][1] (2024/01/25)
...
* **content-picker:** ページネーションコンポーネントを使用して適切なスタイルをインポート ([#3472][18]) ([`6aef87b`][19])
