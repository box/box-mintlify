<Update label="2024-09-17" description="Box AI Platform API (ベータ版) によるメタデータ抽出の提供開始" tags={["新機能", "影響度の高い変更", "API"]}>
...
[1]: /ja/reference/post-ai-extract

[2]: /ja/reference/post-ai-extract-structured
