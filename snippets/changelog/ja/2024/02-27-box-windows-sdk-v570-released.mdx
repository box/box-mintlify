<Update label={<span>Box Windows SDK <code>v5.7.0</code>のリリース</span>} description="2024-02-27" tags={["新機能", "Windows"]}>
  **新機能と機能強化:**

* `GetFolderItems`のマーカーベースのページネーションのバージョンを追加 ([#936][1]) ([`f877a8f`][2])
