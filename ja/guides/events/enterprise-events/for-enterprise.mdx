...
Enterprise Eventを取得するには、`stream_type`を`admin_logs`または`admin_logs_streaming`に設定して[`GET /events`](/ja/reference/get-events) APIを呼び出します。
...
<RelatedLinks
  ...
  items={[
    ...
    { label: "Long pollingイベント", href: "/ja/guides/events/user-events/polling", badge: "ガイド" },
    { label: "ストリーム位置のページネーション", href: "/ja/guides/events/parameters/pagination", badge: "ガイド" }
  ]}
/>
