---
alias_paths:
  0: /guides/events/sign-events
  1: /guides/events/sign-events/
title: Signイベント
...
Box Signイベントの監査には、Enterprise Event Streamを使用します。Box Signの詳細については、<Link href="/guides/box-sign">ガイド</Link>を参照してください。
