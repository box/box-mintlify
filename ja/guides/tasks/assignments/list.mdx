...
特定のタスクのすべての割り当てのリストを取得するには、タスク`id`を指定して[`GET /tasks/:task_id/assignments`](/ja/reference/get-task-assignments-id)を呼び出します。
...
<RelatedLinks
  ...
  items={[
    ...
    { label: "タスク割り当てに関する情報の取得", href: "/ja/guides/tasks/assignments/get", badge: "ガイド" }
  ]}
/>
