...
[e_delete]: /ja/reference/delete-metadata-cascade-policies-id
...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Remove metadata cascade policy", href: "/ja/reference/delete-metadata-cascade-policies-id", badge: "DELETE" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
