...
[e_post]: /ja/reference/post-metadata-cascade-policies-id-apply
...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Force-apply metadata cascade policy to folder", href: "/ja/reference/post-metadata-cascade-policies-id-apply", badge: "POST" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
