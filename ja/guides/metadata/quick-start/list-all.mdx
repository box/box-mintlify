...
related_endpoints:
  0: get_metadata_templates_global
  1: get_metadata_templates_enterprise
related_guides:
  0: metadata/scopes
...
すべてのユーザーが使用できる[グローバルテンプレート](/reference/get-metadata-templates-global)はいくつかあります。
...
これらのテンプレートの多くはBoxの内部使用を目的としたものですが、アプリケーションでこれらを使用したり適用したりすることもできます。会社のニーズに固有のデータを保持するには、[社内のアプリケーションや管理者が作成した](/reference/get-metadata-templates-enterprise)テンプレートがより便利です。
