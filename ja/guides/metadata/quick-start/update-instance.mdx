...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Update metadata instance on file", href: "/ja/reference/put-files-id-metadata-id-id", badge: "PUT" },
    { label: "Update metadata instance on folder", href: "/ja/reference/put-folders-id-metadata-id-id", badge: "PUT" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
