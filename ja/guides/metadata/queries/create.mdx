...
使用可能なすべてのパラメータの詳細については、Boxの他の[メタデータクエリガイド](/guides/metadata/queries)または関連する[エンドポイントリファレンス](/reference/post-metadata-queries-execute-read)を参照してください。

<Card href="/guides/metadata/queries/syntax" arrow title="クエリ構文の詳細を確認する" />
...
<Card href="/guides/metadata/queries/pagination" arrow title="ページ割りクエリの結果の詳細を確認する" />
