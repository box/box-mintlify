...
[get_metadata_file]: /ja/reference/get-files-id-metadata

[get_metadata_folder]: /ja/reference/get-folders-id-metadata

<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "List metadata instances on file", href: "/ja/reference/get-files-id-metadata", badge: "GET" },
    { label: "List metadata instances on folder", href: "/ja/reference/get-folders-id-metadata", badge: "GET" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
  items={[
    { label: "項目のメタデータの取得", href: "/ja/guides/metadata/instances/get", badge: "ガイド" },
