---
related_endpoints:
  0: post_files_id_metadata_id_id
  1: post_folders_id_metadata_id_id
related_guides:
  0: metadata/instances/list
  1: metadata/instances/update
  2: metadata/scopes
related_resources:
  0: metadata
  1: metadata_template
required_guides:
  0: metadata/templates/list
title: 項目へのメタデータの適用
...
[e_on_folder]: /reference/post-folders_id_metadata_id_id
