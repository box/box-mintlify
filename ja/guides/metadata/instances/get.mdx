...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Get metadata instance on file", href: "/ja/reference/get-files-id-metadata-id-id", badge: "GET" },
    { label: "Get metadata instance on folder", href: "/ja/reference/get-folders-id-metadata-id-id", badge: "GET" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
