...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Add classification to file", href: "/ja/reference/post-files-id-metadata-enterprise-securityClassification-6VMVochwUWo", badge: "POST" },
    { label: "Add classification to folder", href: "/ja/reference/post-folders-id-metadata-enterprise-securityClassification-6VMVochwUWo", badge: "POST" }
  ]}
/>
