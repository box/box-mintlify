...
rank: 1
related_endpoints:
  0: post_collaboration_whitelist_entries
related_guides:
  0: collaborations
  1: collaborations/allowed-domains/list
  2: collaborations/allowed-domains/delete
related_pages: {}
related_resources: {}
required_guides: {}
...
この[エンドポイント](/reference/post-collaboration-whitelist-entries)には、コラボレーションを許可する`domain`と、以下のように設定できる`direction`が必要です。
