...
![アプリケーションの選択画面](/images/guides/skills/handle/select-app-type.png)
...
![アプリ名のフォーム](/images/guides/skills/handle/skill-name.png)
...
![アプリ名のフォーム](/images/guides/skills/handle/app-invocation-url.png)
...
![アプリ名のフォーム](/images/guides/skills/handle/app-file-extensions.png)
