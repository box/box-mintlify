...
<RelatedLinks
  ...
  items={[
    ...
    { label: "List archives", href: "/ja/reference/v2025.0/get-archives", badge: "GET" },
    { label: "Delete archive", href: "/ja/reference/v2025.0/delete-archives-id", badge: "DELETE" },
...
<RelatedLinks
  title="関連するガイド"
  items={[
    { label: "Box Archiveへのコンテンツの追加", href: "/ja/guides/archives/add-content", badge: "ガイド" },
    { label: "Box Archiveからのコンテンツの復元", href: "/ja/guides/archives/restore-content", badge: "ガイド" },
    { label: "Box ArchiveでサポートされているAPI", href: "/ja/guides/archives/supported-apis", badge: "ガイド" }
  ]}
/>
<RelatedLinks
