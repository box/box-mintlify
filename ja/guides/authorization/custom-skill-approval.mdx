...
<RelatedLinks
  ...
  items={[
    ...
    { label: "設定", href: "/ja/guides/skills/handle/setup", badge: "ガイド" }
  ]}
/>
...
![追加するスキルの選択](/images/guides/authorization/skills-select.png)
...
![追加するスキルの選択](/images/guides/authorization/skills-confirm.png)
...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Create Box Skill cards on file", href: "/reference/post-files-id-metadata-global-boxSkillsCards", badge: "POST" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
