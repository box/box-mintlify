...
<RelatedLinks
  ...
  items={[
    ...
    { label: "ユーザーとフォルダのプロビジョニング", href: "/ja/guides/cli/scripts/provision-users-folders", badge: "ガイド" },
    { label: "ユーザーのプロビジョニング解除とフォルダのアーカイブ", href: "/ja/guides/cli/scripts/deprovision-users", badge: "ガイド" },
    { label: "ユーザーのゾーンの更新", href: "/ja/guides/cli/scripts/user-zones-mass-update", badge: "ガイド" },
    { label: "非アクティブなユーザーのレポート", href: "/ja/guides/cli/scripts/report-inactive-users", badge: "ガイド" }
  ]}
/>
