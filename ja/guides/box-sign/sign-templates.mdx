...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "List Box Sign templates", href: "/ja/reference/get-sign-templates", badge: "GET" },
    { label: "Get Box Sign template by ID", href: "/ja/reference/get-sign-templates-id", badge: "GET" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
