...
rank: 1
related_endpoints:
  0: post-sign-requests
related_guides:
  0: box-sign/resend-sign-request
  1: box-sign/cancel-sign-request
  2: box-sign/sign-templates
...
<RelatedLinks
  title="関連するガイド"
  items={[
  { label: "Resend Box Sign Request", href: "/guides/box-sign/resend-sign-request", badge: "GUIDE" },
