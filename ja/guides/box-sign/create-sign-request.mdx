...
![準備のオプション](/images/guides/box-sign/prepare.png)
</div>
</Frame>
...
<Frame border center shadow>
<div className="w-full h-full bg-[#FFFFFF] p-2 rounded flex items-center justify-center">
![複数の署名者のフロー](/images/guides/box-sign/multiple_signer_flow.png)
</div>
</Frame>
...
<Frame border center shadow>
<div className="w-full h-full bg-[#FFFFFF] p-2 rounded flex items-center justify-center">
![ステータスの図](/images/guides/box-sign/status.png)
</div>
</Frame>
...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Create Box Sign request", href: "/ja/reference/post-sign-requests", badge: "POST" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
  items={[
    { label: "Box Signのリクエストの再送信", href: "/ja/guides/box-sign/resend-sign-request", badge: "ガイド" },
