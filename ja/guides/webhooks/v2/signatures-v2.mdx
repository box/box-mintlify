---
alias_paths:
  0: /guides/webhooks/handle/setup-signatures
  1: /guides/webhooks/handle/verify-signatures
  2: /guides/webhooks/handle/rotate-signatures
title: 署名の検証
...
手動で署名を検証することもできますが、<Link href="/guides/tooling/sdks">Box公式SDK</Link>には便利なメソッドが用意されています。
