...
| APIモデル名       | `azure__openai__gpt_4o` | <Link href="/guides/box-ai/ai-agents/ai-agent-overrides">Box AI APIでのモデルの上書き</Link>に使用されるモデルの名前。APIを動作させるには、ユーザーがこの名前を正確に指定する必要があります。 |
