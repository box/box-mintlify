...
rank: 7
related_endpoints:
  0: post-ai-extract-structured
  1: post-ai-extract
related_guides:
  0: box-ai/ai-tutorials/prerequisites
  1: box-ai/ai-tutorials/default-agent-overrides
  2: box-ai/ai-tutorials/generate-text
  3: box-ai/ai-tutorials/ask-questions
  4: box-ai/ai-tutorials/extract-metadata-structured
