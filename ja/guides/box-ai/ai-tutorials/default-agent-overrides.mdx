...
Platformアプリを作成して認証するには、<Link href="/guides/box-ai/ai-tutorials/prerequisites">Box AIの使い方</Link>に記載されている手順に従っていることを確認してください。さらにコンテキストを取得するには、<Link href="/guides/box-ai/ai-agents/ai-agent-overrides">エージェントの上書き</Link>を参照してください。
