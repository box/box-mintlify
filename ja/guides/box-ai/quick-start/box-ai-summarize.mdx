...
[Box AI](/ai-dev-zone)は、開発者が単一のAPIコールでドキュメントを照会できるようにするAI機能を公開します。この強力な機能は、複雑な検索拡張生成 (RAG) パイプラインを構築して維持することなく、即座に非構造化ドキュメントのコンテンツをインサイトに変換します。
...
<Steps>
  ...
  <Step title="環境を設定する">
    ...
    開発者トークンを取得するために、[Box開発者コンソール](https://app.box.com/developers/console)に移動し、アプリを開き、\[**構成**] タブに移動します。
