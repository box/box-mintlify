...
[Box AI](/ai-dev-zone)は、開発者が1回のAPIコールでドキュメントからデータを取得できるようにするAI機能を公開しています。この強力な機能により、複雑な検索拡張生成 (RAG) パイプラインを構築および保守する必要なく、非構造化ドキュメントのコンテンツがすぐにインサイトに変換されます。
...
<Steps>
  ...
  <Step title="環境を設定する">
    ...
    開発者トークンを取得するには、[Box開発者コンソール](https://app.box.com/developers/console)に移動し、アプリを開き、\[**構成**] タブに移動します。
