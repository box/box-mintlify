...
<RelatedLinks
  title="関連するAPI"
  items={[
    { label: "Download zip archive", href: "/ja/reference/get-zip-downloads-id-content", badge: "GET" },
    { label: "Get zip download status", href: "/ja/reference/get-zip-downloads-id-status", badge: "GET" },
    { label: "Create zip download", href: "/ja/reference/post-zip-downloads", badge: "POST" }
  ]}
/>
