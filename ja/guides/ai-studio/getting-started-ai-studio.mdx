...
rank: 1
related_guides:
  0: authentication/tokens/developer-tokens/
  1: box-ai/ai-tutorials/ask-questions
  2: box-ai/ai-tutorials/default-agent-overrides
  3: box-ai/ai-tutorials/generate-text
  4: box-ai/ai-tutorials/extract-metadata-structured
  5: box-ai/ai-tutorials/extract-metadata
title: AI Studioの使い方
