...
さらに、認証済みユーザーは、管理者権限を持つユーザー、つまり、管理者または共同管理者である必要があります。詳細については、[ユーザータイプ](/platform/user-types)のガイドを参照してください。

<Info>
  as-userヘッダーでは[サービスアカウント](/platform/user-types/#service-account)の`user_id`を使用できません。
</Info>
