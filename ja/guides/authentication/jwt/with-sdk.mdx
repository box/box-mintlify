...
<Warning>
  **サービスアカウント**
  ...
  この時点では、アプリケーションは、管理対象ユーザーまたはApp Userとしてではなく、アプリケーションユーザーとして認証されます。各種ユーザーの詳細については、[ユーザータイプ](/platform/user-types)に関するガイドをご覧ください。
  ...
  **まとめ**
  ...
  このクライアントの使用方法を確認するには、[APIコールの実行](/guides/api-calls)に関するガイドをご覧ください。
