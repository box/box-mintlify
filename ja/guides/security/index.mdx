---
alias_paths:
  0: /security-and-governance-apis
  1: /docs/android-security-guidelines
rank: 60
...
[serviceaccount]: /platform/user-types/#service-account

[appusers]: /platform/user-types/#app-user
