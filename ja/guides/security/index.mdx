...
<RelatedLinks
  ...
  items={[
    ...
    { label: "Refresh access token", href: "/ja/reference/post-oauth2-token--refresh", badge: "POST" },
    { label: "Revoke access token", href: "/ja/reference/post-oauth2-revoke", badge: "POST" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
