...
<Columns cols={2}>
  <Card icon="cog" title="1. 既存のアプリ - BoxコアSDK" href="/guides/tooling/sdks/sdk-versioning/#migration-from-manually-maintained-sdk-version-to-the-consolidated-sdk-version">
