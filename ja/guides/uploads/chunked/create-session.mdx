...
[createsession]: /ja/reference/post-files-upload-sessions

[createsessionversion]: /ja/reference/post-files-id-upload-sessions
...
<RelatedLinks
  ...
  items={[
    ...
    { label: "Create upload session for existing file", href: "/ja/reference/post-files-id-upload-sessions", badge: "POST" }
  ]}
/>
<RelatedLinks
  title="関連するガイド"
