...
* [フォルダ内の項目を取得](/ja/reference/get-folders-id-items)
* [ファイルのコメントのリストを取得](/ja/reference/get-files-id-comments)
...
<RelatedLinks
  ...
  items={[
    ...
    { label: "List all file versions", href: "/ja/reference/get-files-id-versions", badge: "GET" },
    { label: "List file comments", href: "/ja/reference/get-files-id-comments", badge: "GET" },
    { label: "List trashed items", href: "/ja/reference/get-folders-trash-items", badge: "GET" },
    { label: "Search for content", href: "/ja/reference/get-search", badge: "GET" },
    { label: "List enterprise users", href: "/ja/reference/get-users", badge: "GET" },
    { label: "List members of group", href: "/ja/reference/get-groups-id-memberships", badge: "GET" },
    { label: "List user's groups", href: "/ja/reference/get-users-id-memberships", badge: "GET" },
    { label: "List groups for enterprise", href: "/ja/reference/get-groups", badge: "GET" },
    { label: "List group collaborations", href: "/ja/reference/get-groups-id-collaborations", badge: "GET" },
    { label: "List pending collaborations", href: "/ja/reference/get-collaborations", badge: "GET" },
...
<RelatedLinks
  title="関連するガイド"
  items={[
    { label: "レスポンスの並べ替え", href: "/ja/guides/api-calls/sorting", badge: "ガイド" },
    { label: "マーカーベースのページネーション", href: "/ja/guides/api-calls/pagination/marker-based", badge: "ガイド" }
  ]}
/>
