...
related_endpoints:
  ...
  1: get_files_id_collaborations
  10: get_users
  2: get_folders_id_collaborations
  3: get_webhooks
  4: get_metadata_templates_enterprise
  5: get_recent_items
  6: get_legal_hold_policies
  7: get_enterprises_id_device_pinners
  8: get_users
  9: get_folders_trash_items
related_guides:
  0: api-calls/sorting
  1: api-calls/pagination/offset-based
required_guides: {}
...
* [フォルダ内の項目を取得](/reference/get-folders-id-items)
* [ファイルのコラボレーションのリストを取得](/reference/get-files-id-collaborations)
* [ユーザーのすべてのWebhookのリストを取得](/reference/get-webhooks)
* [社内のすべてのユーザーのリストを取得](/reference/get-users)
* [ごみ箱にあるすべての項目のリストを取得](/reference/get-folders-trash-items)
