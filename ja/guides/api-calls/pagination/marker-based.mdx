...
<RelatedLinks
  ...
  items={[
    ...
    { label: "List file collaborations", href: "/ja/reference/get-files-id-collaborations", badge: "GET" },
    { label: "List folder collaborations", href: "/ja/reference/get-folders-id-collaborations", badge: "GET" },
    { label: "List all webhooks", href: "/ja/reference/get-webhooks", badge: "GET" },
    { label: "List all metadata templates for enterprise", href: "/ja/reference/get-metadata-templates-enterprise", badge: "GET" },
    { label: "List recently accessed items", href: "/ja/reference/get-recent-items", badge: "GET" },
    { label: "List all legal hold policies", href: "/ja/reference/get-legal-hold-policies", badge: "GET" },
    { label: "List enterprise device pins", href: "/ja/reference/get-enterprises-id-device-pinners", badge: "GET" },
