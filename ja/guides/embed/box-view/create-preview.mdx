...
<RelatedLinks
  ...
  items={[
    ...
    { label: "コンテンツプレビュー", href: "/ja/guides/embed/ui-elements/preview", badge: "ガイド" }
  ]}
/>
...
埋め込みURLをAPIから直接生成する場合は、[ファイル情報の取得エンドポイント](/ja/reference/get-files-id)を使用して、`fields`パラメータを介して`expiring_embed_link`をリクエストします。
