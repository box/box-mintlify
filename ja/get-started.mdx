...
Welcome to the Box quick starts! Here you'll find step-by-step guides to help you get started with various Box tools and integrations, including Box AI, the Box CLI, and Postman.
...
<CardGroup cols={2}>
  <Card title="Perform routine or bulk actions in Box with the Box CLI" href="/guides/cli/quick-start" icon="terminal" />

  <Card title="Make API calls to the Box API with Postman" href="/guides/tooling/postman/quick-start" icon="square-arrow-up-right" />
</CardGroup>
