...
**新機能や更新を含む、今後の開発はすべて、BoxコアSDKを通じて提供されます。スタンドアロンの生成されたアーティファクトは、BoxコアSDKのバージョン`v10`で導入されました。**
...
<Card title="Box Postmanコレクションの使い方" href="/ja/guides/tooling/postman/quick-start"/>
...
| JavaScript | [Box UI Elements](/ja/guides/embed/ui-elements)                                                                                                                                            |
...
[nodesdk]: https://github.com/box/box-いいえde-sdk
...
[browseimg]: /static/sdks/browse.webp

[shareimg]: /static/sdks/share.webp

[previewimg]: /static/sdks/preview.webp
