...
<CardGroup cols={2}>
  ...
  <Card
    title="Boxメタデータテンプレートを使用してドキュメントのメタデータ候補を抽出する"
