...
<Steps>
  <Step title="Create and configure a Box application">
    ...
    * Manage AI
    ...
    The "[Create your first application guide](/guides/getting-started/first-application#create-your-first-application)"
  ...
  <Step title="Add Box Metadata to file">
    ...
    You should see your user ID, the extracted metadata, and the attached metadata response from Box.
