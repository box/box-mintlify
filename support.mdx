...
- [Changelog](https://developer.box.com/changelog/): For API changes, deprecated services, and releases.
- [Developer Newsletter](https://developer.box.com/newsletter/): For regular notifications of major events, projects, and releases.
